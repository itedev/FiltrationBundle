        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('disable_knp_sorting')
                    ->defaultTrue()
                ->end()
                ->scalarNode('result_class')
                    ->defaultValue('ITE\FiltrationBundle\Filtration\Result\FiltrationResult')
                ->end()
                ->arrayNode('pagination')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->scalarNode('template')
                            ->defaultValue('ITEFiltrationBundle:Pagination:default.html.twig')
                        ->end()
